...
for i in range(1,len(phase_out_calculus)):
    phase_out_calculus_exp_angle.append( np.angle(np.exp(1j*phase_out_calculus[i]) )+0.940 )
    """
...
for i in range(1,len(phase_out_calculus1)):
    phase_out_calculus_exp_angle1.append( np.angle(np.exp(1j*phase_out_calculus1[i]) )+1.563 )
