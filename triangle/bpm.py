...
steps_image          = my.steps_image
omega                = my.omega
psi_dictionnary      = {}
sigma_gaussian_width = []
t_values             = my.t_values
potential_phase      = []
...
"""
 ...
 | 0.100  | 0.032  | -43.38  |  362.4  |#
 | 0.125  | 0.040  | -34.93  |  266.5  |#
 | 0.250  | 0.079  | -17.49  |  99.96  |
 | 0.500  | 0.158  |  -8.47  |  43.86  |
 | 0.750  | 0.236  |  -5.65  |  27.69  |
 | 1.000  | 0.314  | -4.214  |  22.00  |
 | 1.250  | 0.392  |  -3.49  |  16.77  |
 | 1.500  | 0.466  |  -2.78  |  13.90  |
 | 1.750  | 0.548  |  -2.09  |  10.20  |
 | 2.000  | 0.623  |  -2.10  |  10.17  |
 | 2.250  | 0.697  |  -1.33  |   7.32  |
 ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
...
phase_out_calculus            = [-1.563 , -17.49   , -8.47    , -5.65  , -4.214 , -3.49  , -2.78  , -2.09  , -2.10  , -1.33  ]
